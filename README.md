...
This is one of the most detailed version of the feature, which we could make. The user can define somewhere in the settings (Profile), his default filter. This filter would be activ, if the user opens a new log page. In this verisons, he could also search for specific users or a date. Of course the user can change the filter with the dropdown menu.
...
### My activity page
Would be useful, to see all your recent changes. These changes, you can see in the profile. There would be a new time, calles "Changes"
...
In the second example, you can see also date, time and place from your changes or accesses. Here, you can click the place-link and move directly to the specific account too. More, you can see your changed or watched attribute and the old and new value of an attribute. To see changed passwords values, you need to click on the text "Show PW".
